...
public record RconSettings(
    ...
    final public static int DEFAULT_MAX_PACKET_SIZE = 65535;
    ...
    @Override public @NonNull String toString() {
        return "RconSettings[address=%s, port=%d, password=<redacted>, maxClients=%d, authenticationTimeout=%s, listenBacklog=%d, maxPacketSize=%d, commandTimeout=%s]".formatted(
            this.address,
            this.port,
            this.maxClients,
