...
public final class CooldownRule extends Rule {
	...
	public CooldownRule(Duration cooldown, String message) {
		try {
			...
			throw new CommandConfigurationException("Command cooldown is too large", exception);
		}
		if (this.cooldownNanos < 0) {
			throw new CommandConfigurationException("Command cooldown cannot be negative");
		}
