...
public final class UuidArgument extends Argument<UUID> {
	...
	@Override protected UUID parseValue(CommandSender sender, String value) {
		try {
			...
			throw new ArgumentParseException(this.getName(), value, CommandMessages.format(CommandMessages.ARGUMENT_UUID, "argument", this.getName()), exception);
		}
	}
