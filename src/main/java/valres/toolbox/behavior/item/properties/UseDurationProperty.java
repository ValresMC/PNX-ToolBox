...
public final class UseDurationProperty extends DataDrivenItemProperty {
	...
	public UseDurationProperty(@NonNull Number value) {
		if (!(value instanceof Byte || value instanceof Short || value instanceof Integer || value instanceof Long || value instanceof Float || value instanceof Double)) {
			throw new IllegalArgumentException("Unsupported use duration number type: " + value.getClass().getName());
		}
		this.value = value;
	}
