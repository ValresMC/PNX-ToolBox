...
public final class BundleInteractionComponent extends DataDrivenItemComponent {
	private final int numViewableSlots;

	public BundleInteractionComponent(int numViewableSlots) {
		if (numViewableSlots < 1 || numViewableSlots > 64) {
			throw new IllegalArgumentException("Component 'minecraft:bundle_interaction', value 'num_viewable_slots' " + "must be between 1 and 64, got " + numViewableSlots);
		}
