...
public final class MaxStackSizeComponent extends LegacyItemComponent {
	private final int value;

	public MaxStackSizeComponent(int value) {
		if (value < 1 || value > 64) {
			throw new IllegalArgumentException("Component 'minecraft:max_stack_size' must be between 1 and 64, got " + value);
		}
		this.value = value;
	}
