...
final public class RepairItem implements ItemComponentValue {
    final private List<?> items;
    final private Object repairAmount;
    ...
    public RepairItem(@NonNull Collection<?> items, @NonNull Object repairAmount) {
        ...
        if (!(repairAmount instanceof String || repairAmount instanceof Integer)) {
            throw new IllegalArgumentException(
                "Repair amount must be a String expression or an Integer"
            );
        }
        this.repairAmount = repairAmount;
    }

    public static @NonNull RepairItem of(
