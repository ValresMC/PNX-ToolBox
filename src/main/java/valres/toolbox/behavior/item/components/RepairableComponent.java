...
public final class RepairableComponent extends DataDrivenItemComponent {
	private final List<?> repairItems;

	public RepairableComponent(@NonNull Collection<?> repairItems) {
		this.repairItems = List.copyOf(repairItems);
	}

	public static @NonNull RepairItem repairItem(@NonNull BlockDescriptor item, @NonNull Object repairAmount) {
		return RepairItem.of(item, repairAmount);
	}

	public static @NonNull RepairItem repairItem(@NonNull String item, @NonNull Object repairAmount) {
		return RepairItem.of(item, repairAmount);
	}

	public static @NonNull RepairItem repairItem(@NonNull Map<String, ?> item, @NonNull Object repairAmount) {
		return RepairItem.of(item, repairAmount);
	}

	public static @NonNull RepairItem repairItem(@NonNull Collection<?> items, @NonNull Object repairAmount) {
