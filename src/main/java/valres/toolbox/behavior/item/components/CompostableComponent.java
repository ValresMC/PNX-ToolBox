...
public final class CompostableComponent extends DataDrivenItemComponent {
	...
	public CompostableComponent(float compostingChance) {
		if (compostingChance < 0 || compostingChance > 100) {
			throw new IllegalArgumentException("Component 'minecraft:compostable', value 'composting_chance' " + "must be between 0 and 100, got " + compostingChance);
		}
