...
public final class EnchantableComponent extends DataDrivenItemComponent {
	...
	public EnchantableComponent(@NonNull String slot, int value) {
		if (value < 0 || value > 255) {
			throw new IllegalArgumentException("Component 'minecraft:enchantable', value 'value' " + "must be between 0 and 255, got " + value);
		}
		this.slot = slot;
		this.value = value;
	}
	...
	@Override public @NonNull CompoundTag toNBT() {
		return ComponentNbtHelper.compound("slot", this.slot, "value", this.value);
	}
}
