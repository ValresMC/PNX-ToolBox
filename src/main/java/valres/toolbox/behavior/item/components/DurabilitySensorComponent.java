...
public final class DurabilitySensorComponent extends DataDrivenItemComponent {
	...
	public static @NonNull DurabilityThreshold threshold(int durability, String particleType, String soundEvent) {
