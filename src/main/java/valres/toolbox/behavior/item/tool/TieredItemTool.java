...
public abstract class TieredItemTool extends ItemTool implements ToolTierProvider {
	...
	@Override public Integer getDiggerSpeed(Block block) {
		...
		boolean correctTool = blockToolType == ItemTool.TYPE_PICKAXE && this.isPickaxe() || blockToolType == ItemTool.TYPE_AXE && this.isAxe() || blockToolType == ItemTool.TYPE_SHOVEL && this.isShovel() || blockToolType == ItemTool.TYPE_HOE && this.isHoe() || blockToolType == ItemTool.TYPE_SWORD && this.isSword() || blockToolType == ItemTool.TYPE_SHEARS && this.isShears();
