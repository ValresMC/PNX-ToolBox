...
public final class ItemVersionResolver {
	...
	public static ItemVersion fromClass(@NonNull Class<? extends Item> itemClass) {
		...
		if (hasDataDriven && hasLegacy) {
			throw new IllegalArgumentException("Item '" + itemClass.getName() + "' cannot use both " + "@DataDrivenItem and @LegacyItem annotations");
		}
