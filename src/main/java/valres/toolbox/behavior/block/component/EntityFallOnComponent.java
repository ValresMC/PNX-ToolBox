...
public final class EntityFallOnComponent extends BlockComponent {
	private final double minimumFallDistance;
	...
	@Override public @NonNull Tag toNBT() {
		return ComponentNbtHelper.compound("min_fall_distance", this.minimumFallDistance);
	}
}
