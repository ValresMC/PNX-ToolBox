...
public record MaterialInstance(@NonNull String texture, @Nullable String renderMethod, @Nullable String tintMethod, @Nullable Number ambientOcclusion, @Nullable Boolean faceDimming, @Nullable Boolean isotropic, @Nullable Boolean alphaMaskedTint, @Nullable Boolean packedBools) implements BlockComponentValue {
	public MaterialInstance(@NonNull String texture) {
		this(texture, null, null, null, null, null, null, null);
	}

	public MaterialInstance(@NonNull String texture, @NonNull RenderMethod renderMethod) {
		this(texture, renderMethod.toString(), null, 1f, true, false, null, false);
	}
