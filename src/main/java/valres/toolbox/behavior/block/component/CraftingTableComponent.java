 ...
 */
final public class CraftingTableComponent extends BlockComponent {
    final private List<String> craftingTags;
    ...
    public CraftingTableComponent(
        @NonNull Collection<String> craftingTags,
        @Nullable String tableName
    ) {
        this.craftingTags = List.copyOf(Objects.requireNonNull(
            craftingTags,
            "Crafting tags cannot be null"
        ));
