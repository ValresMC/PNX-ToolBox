...
final public class DestructibleByExplosionComponent extends BlockComponent {
    ...
    public static @NonNull DestructibleByExplosionComponent resistance(
        double resistance
    ) {
    ...
    @Override public @NonNull CompoundTag toNBT() {
        return ComponentNbtHelper.compound(
            ...
            (int) Math.round(this.resistance)
        );
    }
}
