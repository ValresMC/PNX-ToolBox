...
public final class BlockPermutation {
	...
	public BlockPermutation(@NonNull String condition) {
		if (condition.isBlank()) {
			throw new IllegalArgumentException("Permutation condition cannot be empty");
		}
	...
	public @NonNull BlockPermutation setCondition(@NonNull String condition) {
		if (condition.isBlank()) {
			throw new IllegalArgumentException("Permutation condition cannot be empty");
		}
		this.condition = condition;
	...
	public @NonNull BlockPermutation addComponent(@NonNull BlockComponent component) {
	...
	public @NonNull CompoundTag toNBT() {
		...
		return new CompoundTag().putString("condition", this.condition).putCompound("components", componentData);
	}
}
