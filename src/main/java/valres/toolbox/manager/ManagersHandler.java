...
public final class ManagersHandler {
	private static final Comparator<Manager> MANAGER_ORDER = ManagerPriority.comparator();
	...
	public synchronized void registerManager(@NonNull Manager... managers) {
		...
		for (Manager manager : managers) {
			...
			if (this.managers.containsKey(name)) {
				throw new IllegalStateException("Manager '" + name + "' is already registered");
			}
