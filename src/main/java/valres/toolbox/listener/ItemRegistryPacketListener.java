...
public final class ItemRegistryPacketListener implements Listener {
	...
	@EventHandler(priority = EventPriority.HIGHEST, ignoreCancelled = true) public void onPacketSend(PacketSendEvent event) {
